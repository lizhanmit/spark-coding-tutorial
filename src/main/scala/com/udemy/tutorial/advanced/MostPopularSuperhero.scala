package com.udemy.tutorial.advanced
...
object MostPopularSuperhero {
  ...
  def main(args: Array[String]) {
    ...
    val names = sc.textFile("src/main/resources/udemy/inputData/marvel-names.txt")
    val namesRdd = names.flatMap(parseNames)
    
    // Load up the superhero co-apperarance data
    val lines = sc.textFile("src/main/resources/udemy/inputData/marvel-graph.txt")
    ...
    // result is (maxConnectionNumber, heroID)
